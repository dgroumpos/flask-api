import uuid
from sqlalchemy import DECIMAL, Boolean, Column, DateTime, Float, ForeignKey, Integer, String, Text, text
...
class Product(db.Model):
    ...
    created_at = Column(DateTime, server_default=db.text("CURRENT_TIMESTAMP"), onupdate=db.func.now())
    is_active = Column(Boolean, default=False)
